...
if __name__ == '__main__':
    ...
    initial1 = ['space on b', 'b on table', 'space on c', 'c on a', 'a on table', 'space on table']
    goal1 = ['space on a', 'a on table', 'space on b', 'b on table', 'space on c', 'c on table']
    actionSequence1 = gps(
        initial1,
        goal1,
        problem['actions']
